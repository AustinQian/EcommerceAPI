...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv("DATABASE_URL", "postgresql://ecommerce:123456@34.148.186.210:5432/ecommerce")
    #SQLALCHEMY_DATABASE_URI = os.getenv("DATABASE_URL", "postgresql://momori:123456@localhost/carcommerce")
